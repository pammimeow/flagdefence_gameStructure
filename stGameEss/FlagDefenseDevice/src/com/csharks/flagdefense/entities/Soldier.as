package com.csharks.flagdefense.entities
{
	...
	public class Soldier extends CustomIsometricCharacter
	{
		...
		public function Soldier(_tileWidth:Number,_spawnPoint,_screenOffset:Point,isBlue:Boolean=false)
		{
			...
			super("soldier_"+color,162*SR,167*SR,_tileWidth,_spawnPoint,new Point(SR,-132*SR),2,0.1,true);//offset is -5,-57(the image leg point to centre 80x40) if there is no 2D tw/2 offsets
			this.screenOffset=_screenOffset;
			this.setLabels(new Array(
				["walk",3],["idle",2],["blueflagidle",2],
				["greenflagidle",2],["attack",3],["die",3],
				["blueflagwalk",3],["blueflagattack",3],
				["greenflagwalk",3],["greenflagattack",3]));
			this.state="idle";
			/*
			if(isAI){
				subState="blueflag";
